avatar: https://pel-img-1301311422.cos.ap-chengdu.myqcloud.com/blog/Icon/logo.jpeg # 网站 Logo
background: # 既是博客的背景，又是文章默认头图
  path: https://pel-img-1301311422.cos.ap-chengdu.myqcloud.com/blog/Icon/default_cover.jpeg
  width: 800
  height: 500
favicon:
...
social:
  QQ:
    ...
    - rgba(249, 174, 8, .1)
  Gitee:
    - https://gitee.com/wu_ji666
    - icon-github
    - rgb(25, 23, 23)
    - rgba(25, 23, 23, .15)
  GitHub:
    - https://github.com/panern/
    - icon-github
    - rgb(25, 23, 23)
    - rgba(25, 23, 23, .15)
...
analytics: # 统计系统，目前支持 Google analytics.js 统计、Google Tag Manager 统计、CNZZ 统计、腾讯统计、51.La统计、百度统计
  ...
  tencent_site_id: #<ID>
  la_site_id: #<ID>
  baidu_site_id: cb8c3bd9ba0ec8012823be9dc0f565f2 #<ID>
  gtm_container_id: #<ID>

comment: changyan # 评论框，目前支持 gitalk,gitment,valine,disqus,disqusjs,changyan,livere,DiscussBot
...
changyan:
  appid: cyvogbYur # 畅言的 APPID
  conf: prod_09464d4984482efebf569eb51ea4a116 # 畅言的 CONF
